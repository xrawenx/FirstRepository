...
public class AudioManager : MonoBehaviour {
	...
	void Awake() {
        ...
        if (instance != null) {
			...
			masterVolumePercent = PlayerPrefs.GetFloat ("master vol", 100);
			sfxVolumePercent = PlayerPrefs.GetFloat ("sfx vol", 100);
			musicVolumePercent = PlayerPrefs.GetFloat ("music vol", 100);
		}
	}
